...
class DataFild:
    ...
    def get_class_e_mail(self):
        return self.browser.find_element(*self.class_e_mail).get_attribute('class')
    ...
    def get_class_zipcode(self):
        return self.browser.find_element(*self.class_zipcode).get_attribute('class')